...
from ECE60131_Project.experiments.utils import train_model, load_datasets, get_default_parser, print_params
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='CITRISNF')
