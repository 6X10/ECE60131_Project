"""
Run file to train CITRIS-VAE, and CITRIS-VAE-CP models.
"""
...
FILE_DIR = os.path.dirname(os.path.abspath(__file__))      # .../project/experiments
PROJECT_ROOT = os.path.dirname(FILE_DIR)                   # .../project
...
from models.citris_cpd_vae.citris_cp import CITRISTSCP2VAE
...
if __name__ == '__main__':
    ...
    if model_name == 'CITRISVAE':
        model_class = CITRISVAE
    elif model_name == 'CITRISTSCP2VAE':
        model_class = CITRISTSCP2VAE
